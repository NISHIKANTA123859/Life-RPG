        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          {RECOMMENDATIONS.map((rec) => (
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-2 mb-1">
                    ...
                    <span className="text-[10px] font-display font-bold px-2 py-0.5 rounded-full flex-shrink-0" style={{ color: DIFF_COLORS[rec.difficulty], background: `${DIFF_COLORS[rec.difficulty]}20` }}>
              ...
              <button
                className="w-full mt-4 py-2.5 rounded-xl text-sm font-display font-bold text-white hover:opacity-90 transition-opacity"
                style={{ background: "linear-gradient(135deg, #8B5CF6, #22D3EE)", boxShadow: "0 0 12px rgba(139,92,246,0.3)" }}
              >
                Add to Quest Board
              </button>
            </div>
        ...
        <div className="space-y-5">
          ...
          <div className="glass-card rounded-2xl p-5 border border-white/8">
            ...
            <div className="space-y-3">
              {[
                { label: "Best day for quests", value: "Thursday", color: "#8B5CF6" },
          ...
          <div className="glass-card rounded-2xl p-5 border border-white/8">
            ...
            <div className="h-36">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={WEEKLY_COMPLETION} margin={{ top: 0, right: 0, bottom: 0, left: -25 }} barGap={2}>
          ...
          <div className="glass-card rounded-2xl p-5 border border-white/8">
            ...
            <div className="h-44">
              <ResponsiveContainer width="100%" height="100%">
                <RadarChart data={CATEGORY_RADAR} margin={{ top: 0, right: 10, bottom: 0, left: 10 }}>
